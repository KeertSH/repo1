...
public class SubscriberStatusUpdate {
	...
	private static Logger logger = LogManager.getLogger( SubscriberStatusUpdate.class );

	private final int nThreads;
	private DBWriter[] writers;
	private Thread[] threads;

	public SubscriberStatusUpdate( int nThreads ) {
	...
	public void update( SubscriberInfo row ) throws InterruptedException {
	...
	private static class DBWriter implements Runnable, AutoCloseable {
		...
		private final BlockingQueue<SubscriberInfo> queue;
		...
		private void update( SubscriberInfo row ) throws InterruptedException {
			queue.put( row );
		}
